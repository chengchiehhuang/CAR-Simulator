...
// Information about each instruction in the cpu, including function pointer and
// a
...
typedef struct _instruction {
  ...
  const byte alu_operation; // an integer which determines which operation the
                            // ALU should perform
...
const instruction instructions[] = {
  ...
  ,
  { "  multi", NULL, true, 3, 1, false, 0, 0, false, 1 } // 14
  ,
  { "   mult", NULL, true, 3, 0, false, 0, 0, false, 1 } // 15
};
